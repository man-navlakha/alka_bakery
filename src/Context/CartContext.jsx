...
export function CartProvider({ children }) {
    ...
    const getCommonHeaders = () => {
        ...
        // DEBUG LOG: Check if User ID (Token) is being sent
        console.log("🛒 Cart Request - Auth Token Present:", !!token, "| Cart ID:", cartId);

        return {
            "Accept": "application/json",
            "Content-Type": "application/json",
            ...(cartId ? { "x-cart-id": cartId } : {}),
            ...(token ? { "Authorization": `Bearer ${token}` } : {}), // Sends User ID info
        };
  ...
  // split paid items vs free gifts
  ...
  // 🔹 Coupon / discount meta from backend
