                            ...
                            >
                                ...
                                <div className="bg-stone-50/80 p-5 flex flex-wrap justify-between items-center gap-4 border-b border-stone-100">
                                    ...
                                    <div className="text-right">
                                        ...
                                        <span
                                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wide mt-1 ${order.status === "delivered"
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 text-sm">
                                        ...
                                        <div>
                                            ...
                                            <div className="p-3 rounded-xl bg-stone-50 border border-stone-100 text-stone-600 leading-relaxed text-xs">
                                                ...
                                                <p>{order.address_snapshot.house_no}/{order.address_snapshot.floor_no && <span>{order.address_snapshot.floor_no}</span>}, {order.address_snapshot.society_building}, {order.address_snapshot.street_address}</p>
